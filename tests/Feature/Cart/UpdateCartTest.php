...
class UpdateCartTest extends TestCase
{
    ...
    public function guest_cant_visit_update_cart_page()
    {
        ...
        $this->get(route('carts.edit', $cart))
    ...
    public function user_can_visit_update_cart_page()
    {
        ...
        $this->actingAs($user)
            ->get(route('carts.edit', $cart))
            ->assertSuccessful()
            ->assertViewIs('carts.edit')
    ...
    public function guest_cant_update_cart()
    {
        ...
        $this->put(route('carts.update', $cart), $stub)
            ->assertRedirect(route('login'));
    }
    ...
    public function user_can_update_cart()
    {
        ...
        $this->actingAs($user)
            ->put(route('carts.update', $cart), $stub)
            ->assertRedirect(route('orders.show', $stub['order_id']))
    ...
    public function user_cant_update_existing_cart()
    {
        ...
        $this->actingAs($user)
            ->put(route('carts.update', $cart), $existed->toArray())
            ->assertSessionHasErrors('product_id');
    }
