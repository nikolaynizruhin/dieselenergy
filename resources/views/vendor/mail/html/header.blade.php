...
<td class="header">
<a href="{{ $url }}">
<svg width="1.5em" height="1.5em" style="color: #f47214; margin-right: 1rem" viewBox="0 0 16 16" class="bi bi-intersect" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
