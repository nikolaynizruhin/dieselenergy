    ...
    <div class="container">
        <div class="row mb-5">
            ...
            <div class="col-12 col-sm-6 col-md-3 mb-3 mb-md-0">
                ...
                <a href="tel:{{ config('company.phone') }}" class="d-block mb-2">
                    ...
                    <span class="text-gray-400">+38 (097) 799 75 42</span>
                </a>
                <a href="mailto:{{ config('company.email') }}" class="d-block mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail text-gray-400 mr-2">
                        <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline>
                    </svg>
                    <span class="text-gray-400">{{ config('company.email') }}</span>
                </a>
                <a href="{{ config('company.facebook') }}" class="d-block mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook text-gray-400 mr-2">
