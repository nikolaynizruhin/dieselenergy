...
<section style="padding: 70px 0">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md d-flex align-items-center bg-light p-5 justify-content-center" style="margin: 0.1rem">
            ...
            <div class="col-12 col-md d-flex align-items-center bg-light p-5 justify-content-center" style="margin: 0.1rem">
                <svg class="bi bi-shop text-muted" style="opacity: 0.6" width="2.5em" height="2.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 class="mb-0 ml-3 text-muted" style="opacity: 0.6">Stripe</h3>
            </div>
            <div class="col-12 col-md d-flex align-items-center bg-light p-5 justify-content-center" style="margin: 0.1rem">
                <svg class="bi bi-kanban text-muted" style="opacity: 0.6" width="2.5em" height="2.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 class="mb-0 ml-3 text-muted" style="opacity: 0.6">Trello</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-md d-flex align-items-center bg-light p-5 justify-content-center" style="margin: 0.1rem">
                ...
                <h3 class="mb-0 ml-3 text-muted" style="opacity: 0.6">Hand</h3>
            </div>
            <div class="col-12 col-md d-flex align-items-center bg-light p-5 justify-content-center" style="margin: 0.1rem">
                <svg class="bi bi-bootstrap-reboot text-muted" style="opacity: 0.6" width="2.5em" height="2.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M1.161 8a6.84 6.84 0 1 0 6.842-6.84.58.58 0 0 1 0-1.16 8 8 0 1 1-6.556 3.412l-.663-.577a.58.58 0 0 1 .227-.997l2.52-.69a.58.58 0 0 1 .728.633l-.332 2.592a.58.58 0 0 1-.956.364l-.643-.56A6.812 6.812 0 0 0 1.16 8zm5.48-.079V5.277h1.57c.881 0 1.416.499 1.416 1.32 0 .84-.504 1.324-1.386 1.324h-1.6zm0 3.75V8.843h1.57l1.498 2.828h1.314L9.377 8.665c.897-.3 1.427-1.106 1.427-2.1 0-1.37-.943-2.246-2.456-2.246H5.5v7.352h1.141z"/>
                </svg>
                <h3 class="mb-0 ml-3 text-muted" style="opacity: 0.6">Rollback</h3>
            </div>
            <div class="col-12 col-md d-flex align-items-center bg-light p-5 justify-content-center" style="margin: 0.1rem">
                <svg class="bi bi-calendar2-check text-muted" style="opacity: 0.6" width="2.5em" height="2.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
