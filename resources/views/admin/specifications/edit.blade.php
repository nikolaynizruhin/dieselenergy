                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input @error('is_featured') is-invalid @enderror" value="1" name="is_featured" id="inputFeatured" @if (old('is_featured', $specification->is_featured)) checked @endif>
