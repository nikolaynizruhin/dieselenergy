        ...
        <form action="{{ route('admin.products.store') }}" enctype="multipart/form-data" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <textarea name="description" class="markdown form-control @error('description') is-invalid @enderror" id="inputDescription" rows="10" aria-describedby="descriptionHelpBlock">{{ old('description') }}</textarea>
