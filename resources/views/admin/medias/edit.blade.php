                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <div class="form-check">
                            <input type="checkbox" id="inputDefault" class="form-check-input @error('is_default') is-invalid @enderror" value="1" name="is_default" @if (old('is_default', $media->is_default)) checked @endif>
