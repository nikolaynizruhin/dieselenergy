<ul class="nav flex-column d-none d-md-flex">
    ...
    <li class="nav-item">
        <a class="nav-link @if (request()->is('customers')) active @endif d-flex align-items-center" href="{{ route('admin.customers.index') }}">
    ...
    <li class="nav-item">
        <a class="nav-link @if (request()->is('categories')) active @endif d-flex align-items-center" href="{{ route('admin.categories.index') }}">
    ...
    <li class="nav-item">
        <a class="nav-link @if (request()->is('brands')) active @endif d-flex align-items-center" href="{{ route('admin.brands.index') }}">
    ...
    <li class="nav-item">
        <a class="nav-link @if (request()->is('attributes')) active @endif d-flex align-items-center" href="{{ route('admin.attributes.index') }}">
    ...
    <li class="nav-item">
        <a class="nav-link @if (request()->is('images')) active @endif d-flex align-items-center" href="{{ route('admin.images.index') }}">
    ...
    <li class="nav-item">
        <a class="nav-link @if (request()->is('users')) active @endif d-flex align-items-center" href="{{ route('admin.users.index') }}">
