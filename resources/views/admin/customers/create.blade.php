        ...
        <form action="{{ route('admin.customers.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="tel" id="inputPhone" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" aria-describedby="phoneHelp" pattern="[+]{1}380[0-9]{9}" required autocomplete="phone">
