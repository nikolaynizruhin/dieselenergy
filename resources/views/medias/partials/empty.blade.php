<div class="card-body d-flex flex-column align-items-center text-muted">
    ...
    {{ __('No images matched the given criteria.') }}
    <a class="btn btn-outline-primary d-block d-md-inline-block mt-3" href="{{ route('medias.create', ['product_id' => $product_id]) }}" role="button">
        {{ __('Attach Image') }}
    </a>
</div>
