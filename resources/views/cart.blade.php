                ...
                <div class="col-8">
                    <table class="table">
                        ...
                        <tr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col d-flex align-items-center">
                                        <div class="d-flex flex-column">
                                            <span class="font-weight-bold">SDMO H-3100</span>
                                            <span class="text-muted">Diesel Generator</span>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td class="align-middle border-top-0">$1 500</td>
                            <td style="width: 12%" class="align-middle border-top-0">
                            ...
                            <td class="align-middle border-top-0">$3 000</td>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">$2 100</td>
                            ...
                            <td class="align-middle">$3 800</td>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">$5 300</td>
                            <td class="align-middle">
                                <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M11.854 4.146a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708-.708l7-7a.5.5 0 0 1 .708 0z"/>
                                    <path fill-rule="evenodd" d="M4.146 4.146a.5.5 0 0 0 0 .708l7 7a.5.5 0 0 0 .708-.708l-7-7a.5.5 0 0 0-.708 0z"/>
